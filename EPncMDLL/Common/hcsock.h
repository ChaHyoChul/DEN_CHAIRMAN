...
#ifdef __MFCCTRLEXDLL_EXPORTS__
#define MFCCTRLEXDLL_API __declspec(dllexport)
#else
#define MFCCTRLEXDLL_API __declspec(dllimport)
#endif
 ...
 * Socket Helper Class 
 */
class MFCCTRLEXDLL_API CSocketHelper
{
private:
...
extern MFCCTRLEXDLL_API CSocketHelper SOCKET_HELPER;					// SocketHelper 클래스 객체를 전역으로 만들어 사용한다 	
