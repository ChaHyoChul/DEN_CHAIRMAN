// SetupTeachingAutoCalCoordOffsetDlg.cpp : 구현 파일입니다.
//
...
BEGIN_MESSAGE_MAP(CSetupTeachingAutoCalCoordOffsetDlg, CDialogListPage)
	...
	ON_BN_CLICKED(IDC_RADIO_SELECT_FULL, &CSetupTeachingAutoCalCoordOffsetDlg::OnBnClickedRadioSelectFull)
	ON_BN_CLICKED(IDC_RADIO_SELECT_ONLY, &CSetupTeachingAutoCalCoordOffsetDlg::OnBnClickedRadioSelectOnly)
END_MESSAGE_MAP()

//////////////////////////////////////////////////////////////////////////
// CSetupTeachingAutoCalCoordOffsetDlg 메시지 처리기입니다.
//////////////////////////////////////////////////////////////////////////
...
BOOL CSetupTeachingAutoCalCoordOffsetDlg::OnInitDialog()
{
	...
	hcutil::reposbutton( (CButton*)GetDlgItem(IDC_RADIO_SELECT_FULL), this, &recbutton, &CUIrectSTAO);
	hcutil::reposbutton( (CButton*)GetDlgItem(IDC_RADIO_SELECT_ONLY), this, &recbutton, &CUIrectSTAO);
...
LRESULT CSetupTeachingAutoCalCoordOffsetDlg::OnNotifyPointDataListBox(WPARAM wparam, LPARAM lparam)
{
	...
	//////////////////////////////////////////////////////////////////////////
	// 2017.04.28 
	// User 모드에 관계없이, Tool 번호와 Tool Diameter, Disk Thickness 이외 데이터를 수정할 수 없도록 한다 
	/*
	PARAM_TOOL_NO,					// P6050
...
void CSetupTeachingAutoCalCoordOffsetDlg::OnBnClickedButtonStartStop()
{
	...
	if( strBtn == CString( _T("Start") ) )
	{
		...
		if( ret == CMsgDlg::RET_OK ) 
		{
			...
			pa::PPAStatus->GetThreadState()->bFullCalibration = ( nSelectScope_ == 0 ) ? TRUE : FALSE;
...
void CSetupTeachingAutoCalCoordOffsetDlg::OnBnClickedRadioSelectFull() 
{
	// nSelectScope_ = 0;
	UpdateData( TRUE );
}

void CSetupTeachingAutoCalCoordOffsetDlg::OnBnClickedRadioSelectOnly()
{
	// nSelectScope_ = 1;
	UpdateData( TRUE );
}
