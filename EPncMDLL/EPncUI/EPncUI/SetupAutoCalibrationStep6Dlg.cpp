// SetupAutoCalibrationStep6Dlg.cpp : 구현 파일입니다.
//
...
// CSetupAutoCalibrationStep6Dlg 대화 상자입니다.

IMPLEMENT_DYNCREATE(CSetupAutoCalibrationStep6Dlg, CDialogListPage)

CSetupAutoCalibrationStep6Dlg::CSetupAutoCalibrationStep6Dlg(CWnd* pParent /*=NULL*/)
	: CDialogListPage(CSetupAutoCalibrationStep6Dlg::IDD, pParent)
{
}

CSetupAutoCalibrationStep6Dlg::~CSetupAutoCalibrationStep6Dlg()
{
}

void CSetupAutoCalibrationStep6Dlg::DoDataExchange(CDataExchange* pDX)
{
...
void CSetupAutoCalibrationStep6Dlg::StartPageWork()
{
	SetTimer( 1, 100, NULL );
	SetTimer( 2, 100, NULL );
}

void CSetupAutoCalibrationStep6Dlg::StopPageWork()
{
	KillTimer( 1 );
	KillTimer( 2 );
}

BEGIN_MESSAGE_MAP(CSetupAutoCalibrationStep6Dlg, CDialogListPage)
	ON_WM_DESTROY()
    ON_WM_CTLCOLOR()
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_CHECK_TOOL_CLAMP_UNCLAMP, &CSetupAutoCalibrationStep6Dlg::OnBnClickedCheckToolClampUnclamp)
	ON_BN_CLICKED(IDC_CHECK_TOOL2_CLAMP_UNCLAMP, &CSetupAutoCalibrationStep6Dlg::OnBnClickedCheckTool2ClampUnclamp)
END_MESSAGE_MAP()

BOOL CSetupAutoCalibrationStep6Dlg::OnInitDialog()
{
	...
	fntCongratulations_.CreateFont(
		60, 0, 
		0, 0, FW_NORMAL,
		FALSE, FALSE, FALSE, 
		ANSI_CHARSET, 
    ...
    ((CStatic *)GetDlgItem(IDC_STATIC_SUBSTEP1))->SetFont( &fntSubstep_, TRUE );
	((CStatic *)GetDlgItem(IDC_STATIC_SUBSTEP2))->SetFont( &fntSubstep_, TRUE );
	((CStatic *)GetDlgItem(IDC_STATIC_SUBSTEP2_DESC))->SetFont( &fntSubstepDesc_, TRUE );
	((CStatic *)GetDlgItem(IDC_STATIC_SUBSTEP3))->SetFont( &fntSubstep_, TRUE );
    
	((CStatic *)GetDlgItem(IDC_STATIC_SUCCESS_TXT1))->SetFont( &fntSubstepDesc_, TRUE );
	((CStatic *)GetDlgItem(IDC_STATIC_SUCCESS_TXT2))->SetFont( &fntCongratulations_, TRUE );
    ...
    hcutil::reposstatic( (CStatic*)GetDlgItem(IDC_STATIC_SUBSTEP1), this, &recbutton, &PCUIrectST);
    hcutil::reposstatic( (CStatic*)GetDlgItem(IDC_STATIC_SUBSTEP2), this, &recbutton, &PCUIrectST);
    hcutil::reposstatic( (CStatic*)GetDlgItem(IDC_STATIC_SUBSTEP2_DESC), this, &recbutton, &PCUIrectST);
    hcutil::reposstatic( (CStatic*)GetDlgItem(IDC_STATIC_SUBSTEP3), this, &recbutton, &PCUIrectST);
    
    hcutil::reposstatic( (CStatic*)GetDlgItem(IDC_STATIC_SUCCESS_TXT1), this, &recbutton, &PCUIrectST);
    hcutil::reposstatic( (CStatic*)GetDlgItem(IDC_STATIC_SUCCESS_TXT2), this, &recbutton, &PCUIrectST);
...
void CSetupAutoCalibrationStep6Dlg::OnDestroy()
{
    ...
    fntCongratulations_.DeleteObject();
    
	CDialogListPage::OnDestroy();
}

BOOL CSetupAutoCalibrationStep6Dlg::PreTranslateMessage(MSG* pMsg)
{
...
HBRUSH CSetupAutoCalibrationStep6Dlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
	...
	if( nCtlColor == 4 ) {
		...
		switch( nCtrlID )
		{
		case IDC_STATIC_SUBSTEP1:
		case IDC_STATIC_SUBSTEP2:
		case IDC_STATIC_SUBSTEP2_DESC:
		case IDC_STATIC_SUBSTEP3:
		case IDC_STATIC_SUCCESS_TXT1:
		case IDC_STATIC_SUCCESS_TXT2:
			hbr = (HBRUSH)brhBkgnd_;
			break;
		}
	}
...
void CSetupAutoCalibrationStep6Dlg::OnTimer(UINT_PTR nIDEvent)
{
	if( nIDEvent == 1 )
	{
		KillTimer( 1 );
...
void CSetupAutoCalibrationStep6Dlg::OnBnClickedCheckToolClampUnclamp()
{
...
void CSetupAutoCalibrationStep6Dlg::OnBnClickedCheckTool2ClampUnclamp()
{
...
void CSetupAutoCalibrationStep6Dlg::updateState_MenuButton()
{
	// tool clamp
...
void CSetupAutoCalibrationStep6Dlg::writeLog( LPCTSTR log_msg )
{
