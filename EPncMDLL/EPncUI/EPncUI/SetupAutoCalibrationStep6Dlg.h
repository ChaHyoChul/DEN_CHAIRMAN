...
class CSetupAutoCalibrationStep6Dlg : public CDialogListPage
{
	DECLARE_DYNCREATE(CSetupAutoCalibrationStep6Dlg)
    ...
    CFont fntCongratulations_;

private:
	CSetupAutoCalibrationStep6Dlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CSetupAutoCalibrationStep6Dlg();
