...
class CSetupAutoTeachingDlg : public CDialogListPage
{
public:
	CSetupAutoTeachingDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CSetupAutoTeachingDlg();
...
private:
	DECLARE_DYNCREATE(CSetupAutoTeachingDlg)
	...
	afx_msg void OnBnClickedRadioStep7();
