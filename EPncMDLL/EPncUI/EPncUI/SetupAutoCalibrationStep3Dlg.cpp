// SetupAutoCalibrationStep3Dlg.cpp : 구현 파일입니다.
//
...
IMPLEMENT_DYNCREATE(CSetupAutoCalibrationStep3Dlg, CDialogListPage)

CSetupAutoCalibrationStep3Dlg::CSetupAutoCalibrationStep3Dlg(CWnd* pParent /*=NULL*/)
	: CDialogListPage(CSetupAutoCalibrationStep3Dlg::IDD, pParent)
{

}

CSetupAutoCalibrationStep3Dlg::~CSetupAutoCalibrationStep3Dlg()
{
}

void CSetupAutoCalibrationStep3Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogListPage::DoDataExchange(pDX);
}

void CSetupAutoCalibrationStep3Dlg::StartPageWork()
{
	SetTimer( 1, 100, NULL );
	SetTimer( 2, 100, NULL );
}

void CSetupAutoCalibrationStep3Dlg::StopPageWork()
{
	KillTimer( 1 );
	KillTimer( 2 );
}

BEGIN_MESSAGE_MAP(CSetupAutoCalibrationStep3Dlg, CDialogListPage)
	ON_WM_DESTROY()
    ON_WM_CTLCOLOR()
	ON_WM_TIMER()
END_MESSAGE_MAP()

BOOL CSetupAutoCalibrationStep3Dlg::OnInitDialog()
{
...
void CSetupAutoCalibrationStep3Dlg::OnDestroy()
{
...
BOOL CSetupAutoCalibrationStep3Dlg::PreTranslateMessage(MSG* pMsg)
{
...
HBRUSH CSetupAutoCalibrationStep3Dlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CSetupAutoCalibrationStep3Dlg::OnTimer(UINT_PTR nIDEvent)
{
	if( nIDEvent == 1 )
	{
		KillTimer( 1 );
