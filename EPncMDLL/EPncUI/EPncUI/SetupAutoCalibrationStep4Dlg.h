...
class CSetupAutoCalibrationStep4Dlg : public CDialogListPage
{
	DECLARE_DYNCREATE(CSetupAutoCalibrationStep4Dlg)
...
private:
	CSetupAutoCalibrationStep4Dlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CSetupAutoCalibrationStep4Dlg();
