// SetupAutoTeachingStep6Dlg.cpp : 구현 파일입니다.
//
...
// CSetupAutoTeachingStep6Dlg 대화 상자입니다.

IMPLEMENT_DYNCREATE(CSetupAutoTeachingStep6Dlg, CDialogListPage)

CSetupAutoTeachingStep6Dlg::CSetupAutoTeachingStep6Dlg(CWnd* pParent /*=NULL*/)
	: CDialogListPage(CSetupAutoTeachingStep6Dlg::IDD, pParent)
{
}

CSetupAutoTeachingStep6Dlg::~CSetupAutoTeachingStep6Dlg()
{
}

void CSetupAutoTeachingStep6Dlg::DoDataExchange(CDataExchange* pDX)
{
...
void CSetupAutoTeachingStep6Dlg::StartPageWork()
{
	SetTimer( 1, 100, NULL );
	SetTimer( 2, 100, NULL );
}

void CSetupAutoTeachingStep6Dlg::StopPageWork()
{
	KillTimer( 1 );
	KillTimer( 2 );
}

BEGIN_MESSAGE_MAP(CSetupAutoTeachingStep6Dlg, CDialogListPage)
	ON_WM_DESTROY()
    ON_WM_CTLCOLOR()
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_CHECK_TOOL_CLAMP_UNCLAMP, &CSetupAutoTeachingStep6Dlg::OnBnClickedCheckToolClampUnclamp)
	ON_BN_CLICKED(IDC_CHECK_TOOL2_CLAMP_UNCLAMP, &CSetupAutoTeachingStep6Dlg::OnBnClickedCheckTool2ClampUnclamp)
END_MESSAGE_MAP()

BOOL CSetupAutoTeachingStep6Dlg::OnInitDialog()
{
...
void CSetupAutoTeachingStep6Dlg::OnDestroy()
{
...
BOOL CSetupAutoTeachingStep6Dlg::PreTranslateMessage(MSG* pMsg)
{
...
HBRUSH CSetupAutoTeachingStep6Dlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CSetupAutoTeachingStep6Dlg::OnTimer(UINT_PTR nIDEvent)
{
	if( nIDEvent == 1 )
	{
		KillTimer( 1 );
...
void CSetupAutoTeachingStep6Dlg::OnBnClickedCheckToolClampUnclamp()
{
...
void CSetupAutoTeachingStep6Dlg::OnBnClickedCheckTool2ClampUnclamp()
{
...
void CSetupAutoTeachingStep6Dlg::updateState_MenuButton()
{
	// tool clamp
...
void CSetupAutoTeachingStep6Dlg::writeLog( LPCTSTR log_msg )
{
