...
class CSetupAutoTeachingStep6Dlg : public CDialogListPage
{
	DECLARE_DYNCREATE(CSetupAutoTeachingStep6Dlg)
...
private:
	CSetupAutoTeachingStep6Dlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CSetupAutoTeachingStep6Dlg();
